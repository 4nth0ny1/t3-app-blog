    ...
    <BlogWrapper>
      ...
      <div className="flex flex-col py-8 lg:flex-row">
        ...
        <div className="flex min-h-screen w-full flex-col items-center px-4 lg:w-4/5 lg:items-start lg:px-0">
          ...
          <ul>
            <li>
              The routine before you address the ball, should be the same every
              time.
            </li>
            <li>Eyes over the ball [or as close as you can] but never past</li>
            <li>Balance is more important that you think</li>
            <li>Follow thru must be greater than the back swing</li>
            <li>
              A smooth stroke is what you’re going for Straight back and
              straight forward
            </li>
            <li>Never break your wrists</li>
            <li>Ball position How to achieve this.</li> <li>Use a mirror.</li>
          </ul>
          <Paragraph paragraph="Always aim for the exact position. 'Aim small miss small.' Many teachers will tell you that you should try to get your put to have the speed that can go 12-18 inches past the hole. I disagree with this especially during practice. What helped me tremendously, was trying to be as specific as possible. With  putting, “aim small, miss small” is the mantra I recite when I decide how to putt. " />
